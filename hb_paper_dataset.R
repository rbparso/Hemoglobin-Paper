...
hb_data1 = dataset[,names_comb[c(1,40:77)]]
hb_data2 = dataset2[,names_comb[c(1,40:77)]]
...
colnames(hb_data) = c("Age", "Is White?", "Is Black/African-American?", "Is Asian?", "Other Race", "Ethnicity",
                      "High Blood Pressure", "Diabetes", "Obesity", "Chronic Heart Disease", "Chronic Lung Disease",
                      ...
                      "COVID Test Result", "Vaccine Status", "SCD/SCT")
